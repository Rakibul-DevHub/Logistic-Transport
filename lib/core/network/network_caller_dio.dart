...
class NetworkCallerDio {
  ...
  Future<NetworkResponseDio> uploadImage(
    ...
    try {
      ...
      // Dio automatically handles the file as multipart/form-data
      if (imageFile.existsSync()) {
        ...
        // Create MultipartFile without MediaType - Dio handles it automatically
      ...
      // Send request with Dio - Dio handles multipart automatically
