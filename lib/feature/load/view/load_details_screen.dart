...
class _LoadDetailsScreenState extends State<LoadDetailsScreen> {
  ...
  bool _isUploadingPod = false; // Track upload state for overlay
  File? _bolImage;
  File? _podImage;
  String? _bolImageUrl;
  String? _podImageUrl;
  ...
  Future<void> _pickPODImage(ImageSource source) async {
    try {
      ...
      if (pickedFile != null) {
        ...
        // Show loading overlay on POD card
        setState(() {
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildBolScanCard(),
                          SizedBox(height: sectionGap),
                          _buildPodCard(), // POD Card with loading overlay
                          ...
                          // ✅ Button stays unchanged during upload
                          CustomElevatedButton(
