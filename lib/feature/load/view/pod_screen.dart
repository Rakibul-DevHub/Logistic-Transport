            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  CustomElevatedButton(
                    onPressed: hasImage ? _continueToBOL : _showImageSourceDialog,
                    buttonText: hasImage ? 'Continue to BOL' : 'Upload POD Image',
                    backgroundColor: hasImage ? AppColors.primaryColor : Colors.grey.shade300,
                    foregroundColor: hasImage ? AppColors.whiteColor : Colors.grey.shade600,
                    height: 48,
                    borderRadius: BorderRadius.circular(30),
                    isFullWidth: true,
                    hasShadow: false,
