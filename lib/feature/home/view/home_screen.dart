...
class HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _homeLoadsCubit = HomeLoadsCubit();
    _homeReportCubit = HomeReportCubit()..fetch(); // Will load from cache first
    _accountSettingsCubit = AccountSettingsCubit();
    _resolveParentDriverFlag();
  }
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeReportCubit, HomeReportState>(
      builder: (context, state) {
        ...
        final isFromCache = state is HomeReportSuccess && state.fromCache;
...
// ---------------------------------------------------------------------------
// Status Overview Section - Using your existing SVG icons with cache support
// ---------------------------------------------------------------------------
